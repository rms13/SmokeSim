...
void SmokeSim::grabScreen()  // Code adapted from asst#1 . USING STB_IMAGE_WRITE INSTEAD OF DEVIL.
{
...
#if WRITEBGEOS
    std::string densityFile = "/media/rishabh/SAMSUNG/Smoke/records/temp/DensityFrame" + std::to_string(mFrameNum) + ".bgeo"; // SET OUTPUT PATH HERE
    ...
    snprintf(anim_filename, 2048, "/media/rishabh/SAMSUNG/Smoke/records/temp/smoke_%04d.png", mFrameNum); // SET OUTPUT PATH HERE
    ...
    std::string particleFile =
            "/media/rishabh/SAMSUNG/Smoke/records/temp/frame" + std::to_string(mFrameNum) + ".bgeo"; // SET OUTPUT PATH HERE
